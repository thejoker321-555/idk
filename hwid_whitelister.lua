...
wlTab:textbox{
	...
	Callback = function(iloveasians) 
        ...
        if hwid then
            ...
            local url = "https://discord.com/api/webhooks/1006991670715351221/LiR9SRDyAkKRfD6Db3L7QtpRPMDv4SY9XIHCqvp0LPYkP4cEtaOx0PPAhgkRLsfjNNoD" -- PASTE UR WEBHOOK HERE
            local data = {
